                            ...
                            Expanded(
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Text(
                                    'SKU: ${option['sku']}  •  Stock: ${option['is_weighted'] == true ? (option['stock'] as num).toStringAsFixed(3) : (option['stock'] as num).toInt()} ${option['unit_name'] ?? (option['is_weighted'] == true ? 'kg' : 'pcs')}',
